...
const AboutPage = () => {
  ...
  return (
    <div className="mx-auto max-w-6xl p-8">
      ...
      >
        <h1 className="mb-6 bg-gradient-to-r from-purple-600 via-blue-600 to-red-600 bg-clip-text text-6xl font-bold text-transparent">
          About Me
        </h1>
        <p className="mb-12 max-w-3xl text-xl">
      ...
      >
        <h2 className="mb-8 text-3xl font-semibold">Technical Expertise</h2>
        <div className="rounded-lg bg-card p-6">
          <GitBranchIcon className="mb-4" size={24} />
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <h3 className="mb-4 text-xl font-semibold text-black dark:text-white">
                Core Technologies
              </h3>
              <ul className="space-y-2 text-slate-900 dark:text-slate-400">
      ...
      <div
        ...
        className="my-16"
      >
        <h2 className="mb-8 text-3xl font-semibold">Professional Journey</h2>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <div className="rounded-lg bg-card p-6">
            <TerminalIcon className="mb-4 text-purple-600" size={24} />
          ...
          <div className="rounded-lg bg-card p-6">
            <Code2Icon className="mb-4 text-blue-600" size={24} />
            <h3 className="mb-2 text-xl font-semibold text-black dark:text-white">
              Previous Experience
            </h3>
            <p className="text-slate-900 dark:text-slate-400">
      ...
      >
        ...
        <div className="rounded-lg bg-card p-6">
          <BookIcon className="mb-4 text-red-600" size={24} />
          <h3 className="mb-2 text-xl font-semibold text-black dark:text-white">
            Academic Background
          </h3>
          <div className="space-y-4 text-slate-900 dark:text-slate-400">
            <p>
